...
python pretrain.py --seed 0 --dataset cub --data_path $DATA_ROOT --model ResNet12 --method meta_deepbdc --image_size 84 --gpu ${gpuid} --lr 5e-2 --t_lr 5e-2 --epoch 400 --milestones 401 --save_freq 10 --reduce_dim 640 --dropout_rate 0.6 --val last \
>log-pretrain/BDC-cub-resnet12.txt