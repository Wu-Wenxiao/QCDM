...
parser.add_argument('--n_query', default=16, type=int, help='number of unlabeled data in each class during meta validation')
...
for _ in range(params.test_task_nums):
    ...
    for _, (x, _) in enumerate(tqdm_gen):
        with torch.no_grad():
            ...
            # scores = model.set_forward_adapt(x, False)
